...
namespace MyRealtyWeb.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public string AssignRolesToUser(string id, string[] rolesToAssign)
        {

            var appUser = UserManager.FindByName(id);
        ...
        public string GetAllRoles()
        {
            ...
            List<RoleReturnModel> mdls = new List<RoleReturnModel>();
            var md = roles.Select(st => st.Name).ToList();
            foreach (var m in md)
            {
                mdls.Add(new RoleReturnModel { Name = m });
            }
            return Newtonsoft.Json.JsonConvert.SerializeObject(mdls);
        }
        ...
        public string DeleteRole(string Id)
        {
            ...
            if (role != null)
            {
                IdentityResult result = AppRoleManager.Delete(role);
